...
public class Medicamentos {
    ...
    public Medicamentos(String codigo, String nome, String descricao, String principioAtivo,
                        LocalDate dataValidade, int quantidadeEstoque, BigDecimal preco, boolean controlado) {
        this.codigo = codigo;
        this.nome = nome;
